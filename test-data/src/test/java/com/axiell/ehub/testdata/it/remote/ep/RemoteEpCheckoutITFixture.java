...
import com.axiell.ehub.testdata.it.remote.RemoteCheckoutITFixture;
...
public abstract class RemoteEpCheckoutITFixture extends RemoteCheckoutITFixture {
    ...
    @Test
    public final void checkoutWithContentProviderError() throws EhubWebApplicationException {
