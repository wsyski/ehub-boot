...
public class LinksTest {
    ...
    private static final String CREATED_LOAN_JSON = "{ \"CreatedLoan\": { \"ProductID\": 1002445, \"LoanID\": 100000094, \"ExpiryDate\": \"2014-04-18\", \"Links\": [{ \"Contents\": [{ \"Part\": 1, \"Url\": \"https://webservices.elib.se/v2/Fulfillment/?data=...omitted\" }], \"FormatID\": 4103 }], \"CreatedDate\": \"2014-03-21\", \"Supplements\": [], \"CoverImage\": \"http://www.elib.se/cover_images/9185201227.jpg\", \"Active\": true, \"Title\": \"Ringaren i Notre-Dame\" } }";
    private static final String LOAN_JSON = "{ \"Loan\": { \"ProductID\": 1002445, \"LoanID\": 100000094, \"ExpiryDate\": \"2014-04-18\", \"Links\": [{ \"Contents\": [{ \"Part\": 1, \"Url\": \"https://webservices.elib.se/v2/Fulfillment/?data=...omitted\" }], \"FormatID\": 4103 }], \"CreatedDate\": \"2014-03-21\", \"Supplements\": [], \"CoverImage\": \"http://www.elib.se/cover_images/9185201227.jpg\", \"Active\": true, \"Title\": \"Ringaren i Notre-Dame\" } }";
    ...
    private void whenGetContentFromCreatedLoan() throws IOException {
        ...
        contentUrl = createdLoan.getContentUrlFor(FORMAT_ID);
    }
    ...
    private void whenGetContentFromLoan() throws IOException {
        ...
        contentUrl = loan.getContentUrlFor(FORMAT_ID);
    }

    private void thenActualUrlEqualsExpectedUrl() {
        Assert.assertEquals(EXP_URL, contentUrl);
    }
}
