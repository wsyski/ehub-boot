...
import com.axiell.ehub.local.provider.overdrive.IOverDriveFacade;
import com.axiell.ehub.local.provider.overdrive.OAuthAccessToken;
import com.axiell.ehub.local.provider.overdrive.OverDriveFacade;
import com.axiell.ehub.local.provider.overdrive.Product;
...
public abstract class AbstractOverDriveIT extends AbstractContentProviderIT {
    ...
    // Card #3
    // private static final String LIBRARY_CARD = "D4000000416455";
    // private static final String PIN = "2379";

    // Card #4
    // private static final String LIBRARY_CARD = "D4000000358164";
    // private static final String PIN = "1030";
