package com.axiell.ehub.v1;

import com.axiell.ehub.EhubError;
import com.axiell.ehub.InternalServerErrorException;
import com.axiell.ehub.v1.loan.PendingLoan_v1;
import com.axiell.ehub.v1.loan.ReadyLoan_v1;
...
public final class XjcSupport {
     ...
     * @throws javax.xml.bind.JAXBException if an exception occurred when unmarshalling the XML document
     */
     ...
     * <p/>
     * <p>
     * This method together with the class {@link com.axiell.ehub.v1.XjcSupport.JaxbContextHolder} exploits the
    ...
    private static class JaxbContextHolder {
        ...
        private static final Class<?>[] CONTEXT_PATH =
                {PendingLoan_v1.class, ReadyLoan_v1.class, Formats_v1.class, EhubError.class};
