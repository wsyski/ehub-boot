...
public interface IAskewsFacade {
    LoanRequestResult processLoan(Integer userId,
            Integer authId,
    ...
    ArrayOfLoanDetails getLoanDetails(Integer userId, Integer authId, Integer loanType, Integer loanId, String tokenKey);
}
