...
final class CirculationResourceFactory {
    ...
    static ICirculationResource create(final ContentProviderConsumer contentProviderConsumer) {
        ...
        return JAXRSClientFactory.create(baseUrl, ICirculationResource.class, Collections.singletonList(jsonProvider), Collections.singletonList(loggingFeature), null);
    }
}
