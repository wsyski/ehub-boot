...
public class Signature {
    ...
    public Signature(final String siteId, final String libraryCard, final String secretKey) {
        this.siteId = siteId;
    ...
    public String toString() {
        byte[] input = StringConverter.getBytesInUtf8(String.format(SIGNATURE_FORMAT, siteId, libraryCard, time));
