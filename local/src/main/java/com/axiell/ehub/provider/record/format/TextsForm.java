...
class TextsForm extends StatelessForm<FormatDecoration> {
    ...
    TextsForm(final String id, final FormatDecorationMediator formatDecorationMediator) {
	super(id);
	...
	final List<Language> languages = languageAdminController.getLanguages();
        final ListView<Language> textsListView = new TextsListView("texts", languages, formModel, formatDecorationMediator);
        add(textsListView);
    }
