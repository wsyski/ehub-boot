...
import com.axiell.ehub.lms.arena.client.ILocalRestApiService;
import com.axiell.ehub.lms.arena.error.RestApiError;
import com.axiell.ehub.lms.arena.exception.RestApiException;
import com.axiell.ehub.lms.arena.resources.patrons.dto.CheckOutTestSummary;
...
public class ArenaLocalApiDataAccessor extends BaseLmsDataAccessor implements ILmsDataAccessor {

    @Autowired
    @Qualifier("localRestApiClient")
    private ILocalRestApiService localRestApiService;
    ...
    private RuntimeException handleRestApiException(final RestApiException restApiException, final EhubConsumer ehubConsumer,
        ...
        RestApiError restApiError = restApiException.getRestApiError();
