...
final class EditContentProviderConsumerSubmitButton extends Button {
    ...
    EditContentProviderConsumerSubmitButton(final String id, final ConsumersMediator consumersMediator, final IModel<ContentProviderConsumer> formModel) {
        super(id);
