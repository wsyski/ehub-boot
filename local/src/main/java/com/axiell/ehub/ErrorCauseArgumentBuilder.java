...
public class ErrorCauseArgumentBuilder {
    ...
    public ErrorCauseArgumentBuilder(final IErrorCauseArgumentValueRepository errorCauseArgumentValueRepository, final ErrorCauseArgument.Type type, final ErrorCauseArgumentValue.Type valueType) {
    ...
    private String getValue() {
        ...
        return errorCauseArgumentValue.getText(language);
    }
}
