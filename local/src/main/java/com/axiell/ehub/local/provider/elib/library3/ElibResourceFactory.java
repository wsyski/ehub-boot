...
final class ElibResourceFactory {
    ...
    public static IElibResource create(final ContentProviderConsumer contentProviderConsumer) {
        ...
        return JAXRSClientFactory.create(baseUrl, IElibResource.class, Collections.singletonList(jacksonJsonProvider), Collections.singletonList(loggingFeature), null);
    }
}
