...
final class DiscoveryResourceFactory {
    ...
    static IDiscoveryResource create(final ContentProviderConsumer contentProviderConsumer) {
        ...
        return JAXRSClientFactory.create(baseUrl, IDiscoveryResource.class, Collections.singletonList(jacksonJsonProvider), Collections.singletonList(loggingFeature), null);
    }
}
