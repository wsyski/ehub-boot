 ...
 * <code>{@link #setPageCreator(PageCreator)}</code> method.
 * </ul>
 ...
 * <code>{@link #setCloseButtonCallback(CloseButtonCallback)}</code>. If you want to be
 ...
 * <code>{@link #setWindowClosedCallback(WindowClosedCallback)}</code>.
 * <p>
 ...
 * transparent or semitransparent. <code>{@link #setMaskType(MaskType)}</code> alters
 * this.
 * </ul>
...
public class ModalWindow extends Panel {
     ...
     *
     * @param minimalWidth Minimal window width.
     * @return this
     */
     ...
     * stored in cookie.
     *
     * @param initialWidth Initial width of the window
     * @return this
     */
     ...
     * in cookie.
     *
     * @param initialHeight Initial height of the window
     * @return this
     */
     ...
     *
     * @param useInitialHeight Whether to use initial height instead of preserving content height instead of
     ...
     * not resizable.
     *
     * @param heightUnit CSS unit for initial window height.
     * @return this
     */
    ...
    /**
     * @see Panel#onComponentTag(ComponentTag)
     */
    @Override
    ...
    /**
     * @see org.apache.wicket.MarkupContainer#remove(Component)
     */
    @Override
     ...
     *
     * @param autoSize Whether window size will be automatically adjusted
     * @return this
     */
     ...
     * <code>{@link ModalWindow#setCloseButtonCallback(CloseButtonCallback)}</code>, no
    ...
    public interface CloseButtonCallback extends IClusterable {
         ...
         * call, so <code>{@link AjaxRequestTarget}</code> instance is
         * available.
         *
         * @param target <code>{@link AjaxRequestTarget}</code> instance bound
     ...
     * {@link ModalWindow#setWindowClosedCallback(WindowClosedCallback)}, no ajax
