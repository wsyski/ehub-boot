...
public class ContentProviderConsumer extends AbstractTimestampAwarePersistable<Long> {
    ...
    static {
        ...
        VALID_PROPERTY_KEYS.put(BORROWBOX, newHashSet(BORROWBOX_LIBRARY_ID, BORROWBOX_SECRET_KEY));
    }
    ...
    public static enum ContentProviderConsumerPropertyKey {
        ...
        F1_USERNAME, F1_PASSWORD, F1_REGION_ID, OCD_LIBRARY_ID, OCD_BASIC_TOKEN, BORROWBOX_LIBRARY_ID, BORROWBOX_SECRET_KEY
    }
}
