...
public class ContentProviderConsumer extends AbstractTimestampAwarePersistable<Long> {
    ...
    public static enum ContentProviderConsumerPropertyKey {
        ...
        F1_USERNAME, F1_PASSWORD, F1_REGION_ID, OCD_LIBRARY_ID, OCD_BASIC_TOKEN, BORROWBOX_SITE_ID, BORROWBOX_LIBRARY_ID, BORROWBOX_SECRET_KEY, GENERIC_SITE_ID, GENERIC_SECRET_KEY
    }
}
