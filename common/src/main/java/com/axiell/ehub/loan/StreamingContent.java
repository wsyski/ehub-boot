...
/**
 * Represents a content that can be streamed, e.g. it can be a Flash player.
 */
public final class StreamingContent implements IContent {
    private String url;
    private int width;
    private int height;
     ...
     * 
     * @param url the URL to the content to be streamed
    ...
    /**
     * Returns the URL to the content to be streamed.
     * 
    ...
    /**
     * Sets the URL to the content to be streamed.
     * 
     * @param url the URL to the content to be streamed to set
     */
