...
abstract class LoggingInterceptor implements WriterInterceptor {
     ...
     */
    static final String ENTITY_LOGGER_PROPERTY = LoggingInterceptor.class.getName() + ".entityLogger";
    /**
     * Logging record id property
     */
    static final String LOGGING_ID_PROPERTY = LoggingInterceptor.class.getName() + ".id";
     ...
     */
    LoggingInterceptor(final Logger logger, final Verbosity verbosity, final int maxEntitySize) {
        this.logger = logger;
    ...
    public void aroundWriteTo(final WriterInterceptorContext writerInterceptorContext)
        ...
        if (logger.isInfoEnabled() && printEntity(verbosity, writerInterceptorContext.getMediaType())) {
            if (stream != null) {
