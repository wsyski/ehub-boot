 ...
 * <p>
 * The filter and can be used on server side only. The Priority
...
public final class ServerLoggingFilter extends LoggingInterceptor implements ContainerRequestFilter, ContainerResponseFilter {

    public ServerLoggingFilter() {
        this(LoggerFactory.getLogger(LoggingInterceptor.class),Verbosity.PAYLOAD_ANY,8 * 1024);
    }
     ...
     */
    public ServerLoggingFilter(final Logger logger, final Verbosity verbosity, final int maxEntitySize) {
        super(logger, verbosity, maxEntitySize);
    }
