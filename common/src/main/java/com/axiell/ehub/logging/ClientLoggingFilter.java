 ...
 * <p>
 * The filter can be used on client side only. The priority
...
public final class ClientLoggingFilter extends LoggingInterceptor implements ClientRequestFilter, ClientResponseFilter {
    ...
    public ClientLoggingFilter() {
        this(LoggerFactory.getLogger(LoggingInterceptor.class),Verbosity.PAYLOAD_TEXT,8 * 1024);
    }
     ...
     */
    public ClientLoggingFilter(final Logger logger, final Verbosity verbosity, final int maxEntitySize) {
