...
public class EhubAuthHeaderParser_SerializeTest extends EhubAuthHeaderParserFixture {
    ...
    public void testSerialize() throws EhubException {
        ...
        Assertions.assertEquals(expInfoValue1, actInfoValue1);
        ...
        Assertions.assertEquals(expInfoValue2, actInfoValue2);
        ...
        Assertions.assertEquals(expInfoValue3, actInfoValue3);
        ...
        Assertions.assertEquals(expInfoValue4, actInfoValue4);
    }
    ...
    public void testMissingSecretKey() {
        ...
        Exception exception = assertThrows(MissingSecretKeyRuntimeException.class, () -> {
