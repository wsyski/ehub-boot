...
public class HmacSHA1HashFunctionTest {
    ...
    /**
     * Test method for {@link HmacSHA1HashFunction#hmacSha1(byte[], byte[])}.
    ...
    public void testHmacSha1() throws UnsupportedEncodingException {
       ...
       byte[] digest1 = HmacSHA1HashFunction.hmacSha1(input, key1);
       byte[] digest2 = HmacSHA1HashFunction.hmacSha1(input, key2);
       byte[] digest3 = HmacSHA1HashFunction.hmacSha1(input, key3);
