 ...
 * {@link EhubRuntimeException}s thrown by the {@link EhubClient} to {@link EhubException}s.
 */
@Aspect
public class ClientResponseFailureAspect {
    ...
    public void toEhubException(final ClientResponseFailure crf) throws EhubException {
        ...
        if (contentTypes == null) {
            ...
            if (contentTypes.contains(MediaType.APPLICATION_XML)) {
                ...
                if (xml == null) {
                    ...
                    /*
                     * Must use this "manual" unmarshaller and not 'response.getEntity(EhubError.class)' since the type
                     * of the entity in the response is String
                     */
                    try {
                        ehubError = XjcSupport.unmarshal(xml, EhubError.class);
    ...
    public void toEhubException(final EhubRuntimeException ere) throws EhubException {
