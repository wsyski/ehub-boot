...
public class RemoteFormatIT extends RemoteFormatITFixture {
    ...
    protected void whenGetFormats() throws EhubException {
        actualFormats = ehubService.getFormats(authInfo, CONTENT_PROVIDER_ALIAS,  TestDataConstants.RECORD_ID_0, LANGUAGE);
    }
    ...
    private void whenGetFormatsWithInvalidAuthInfo() throws EhubException {
        ehubService.getFormats(invalidAuthInfo, CONTENT_PROVIDER_ALIAS,  TestDataConstants.RECORD_ID_0, LANGUAGE);
    }
}
