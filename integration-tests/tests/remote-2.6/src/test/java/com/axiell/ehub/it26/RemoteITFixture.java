...
import com.axiell.ehub.it26.util.ContentProviderErrorExceptionMatcher;
import com.axiell.ehub.it26.util.EhubExceptionMatcher;
...
public abstract class RemoteITFixture extends PalmaITFixture {
    ...
    private void setUpEhubClient() {
        ...
        ApplicationContext springContext = new ClassPathXmlApplicationContext("/com/axiell/ehub/remote-client-context.xml");
