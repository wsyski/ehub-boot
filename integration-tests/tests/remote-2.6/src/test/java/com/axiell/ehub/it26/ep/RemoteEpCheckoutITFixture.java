package com.axiell.ehub.it26.ep;

import com.axiell.ehub.EhubException;
import com.axiell.ehub.ErrorCauseArgumentType;
import com.axiell.ehub.checkout.*;
import com.axiell.ehub.it26.RemoteCheckoutITFixture;
import com.axiell.ehub.it26.util.ContentLinkMatcher;
import com.axiell.ehub.it26.util.SupplementLinkMatcher;
...
public abstract class RemoteEpCheckoutITFixture extends RemoteCheckoutITFixture {
    ...
    protected void thenValidContentLinks(final ContentLinks contentLinks, final String contentProviderFormatId) {
        ...
        assertThat(contentLinks.getContentLinks().get(0),
                ContentLinkMatcher.matchesExpectedContentLink(new ContentLink("http:/localhost:16521/ep/api/v1/records/recordId_0/" + contentProviderFormatId + "/content_0")));
        assertThat(contentLinks.getContentLinks().get(1),
                ContentLinkMatcher.matchesExpectedContentLink(new ContentLink("http:/localhost:16521/ep/api/v1/records/recordId_0/" + contentProviderFormatId + "/content_1")));
    }
    ...
    protected void thenValidSupplementLinks(final SupplementLinks supplementLinks, final String contentProviderFormatId) {
        ...
        assertThat(supplementLinks.getSupplementLinks().get(0),
                SupplementLinkMatcher.matchesExpectedSupplementLink(
