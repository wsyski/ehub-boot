...
@SpringBootTest(classes = {EhubApplication.class, TestDataRestApiServerConfig.class, TestDataServiceClientConfig.class}, webEnvironment = WebEnvironment.RANDOM_PORT, properties = "server.port=0")
@DirtiesContext
